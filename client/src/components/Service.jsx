                                ...
                                <div class="cv-feature-img">
                                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                        <g>
                                            ...
                                            <path
                                                d="m422 102.356c0-24.813-20.187-45-45-45h-332c-24.813 0-45 20.187-45 45v9h422z" />
                                            <path
                                    ...
                                    <div class="cv-service-box align-items-center">
                                        <div class="cv-service-icon">
                                            <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path
                                                        d="m256 166c-41.353 0-75 33.647-75 75s33.647 75 75 75 75-33.647 75-75-33.647-75-75-75zm-30 118.711-21.211-21.211 21.211-21.211 21.211 21.211zm8.789-81.211 21.211-21.211 21.211 21.211-21.211 21.211zm51.211 81.211-21.211-21.211 21.211-21.211 21.211 21.211z" />
                                                    <path
                                    ...
                                    <div class="cv-service-box align-items-center">
                                        <div class="cv-service-icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                                ...
                                                <path
                                                    d="M300.308,388.923h-88.615c-59.721,0-108.308,48.587-108.308,108.308c0,8.157,6.613,14.769,14.769,14.769h275.692
                                    ...
                                    <div class="cv-service-box align-items-center">
                                        <div class="cv-service-icon align-items-center">
                                            <svg viewBox="0 0 512.114 512.114" xmlns="http://www.w3.org/2000/svg">
                                                <g>
                                                    <path
                                                        d="m256.057 60.118c15.242 0 30.27 1.419 45.002 4.202v-34.32h30v-30h-150.004v30h30v34.32c14.732-2.783 29.76-4.202 45.002-4.202z" />
                                                    <path
                                                        d="m256.057 90.118c-116.531 0-210.998 94.467-210.998 210.998s94.467 210.998 210.998 210.998 210.998-94.467 210.998-210.998-94.467-210.998-210.998-210.998zm0 346.994c-74.988 0-135.996-61.008-135.996-135.996s61.008-135.996 135.996-135.996 135.996 61.008 135.996 135.996-61.008 135.996-135.996 135.996z" />
                                                    <path d="m271.057 286.116h89.93c-6.611-46.466-43.464-83.318-89.93-89.93z" />
                                                    <path
                                                        d="m241.057 316.116v-119.93c-51.368 7.309-90.996 51.575-90.996 104.93 0 58.446 47.55 105.996 105.996 105.996 53.355 0 97.621-39.628 104.93-90.996z" />
                                                </g>
                                            </svg>
                                        </div>
                                        <div class="cv-service-text">
                            ...
                            <div class="cv-help-box">
                                <div class="cv-help-icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                        ...
                                        <path
                                            d="M256.002,116.361c-13,0-23.174,9.326-23.174,20.065c0,10.739,10.174,20.348,23.174,20.348
                                ...
                                <span>Always ready to provide the best solution</span>
                                <p>Home care is “the provision of equipment and services to the patient in the home for the
                                purpose of restoring and maintaining his or her maximal level of comfort, function, and
                                health. Home care is able to address a wide spectrum of patient care needs. By
                                integrating physician house calls into the home care paradigm, this definition can be
                                broadened to encompass nearly all aspects of medical care. In any case, effective
                                home-based care requires a collaborative effort of patient, family, and professionals.
                        </p>
                            </div>
                        </div>
                        <div class="col-md-6">
